...
client.on("messageCreate", async (message) => {
    ...
    if (message.content.startsWith(prefix + "rangválasztó1")) {
        ...
        const rangválasztó1 = new MessageEmbed()
            .setTitle("1. Add meg a jelenlegi valorant rankodat:")
            .setDescription(`
            ...
            `)
            .setImage("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/50ca5b2f-036a-4021-95b5-7c0f86d7b9a1/de0tyff-9efba6d3-d8c0-44c9-b25f-9445d45b34ab.png/v1/fit/w_784,h_231,q_70,strp/pick_roles_banner_by_akibanax_de0tyff-414w-2x.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Vo_m2QbrWPnct4eY6d7ajd0vm-FhOkx1S6MHhVoafrw");
